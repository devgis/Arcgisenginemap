<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tianyu_lp_detail.aspx.cs" Inherits="房产系统.tianyu_lp_detail" %>
...
<body>
    ...
    <div id="dh" style="background: RGB(223,223,223)">
        <table style="width: 1197px; height: 30px">
            <tr>
                ...
                <td style="height: 24px; width: 33%">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                        href="tianyu_lp_photo.aspx"><font color="black">楼盘相册</font></a>
                </td>
                <td style="height: 24px; width: 33%; background-color: red">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="tianyu_lp_detail.aspx"><font color="black">楼盘详情</font></a>
                </td>
            </tr>
        </table>
    </div>
  ...
  <div id="center">
        <table style="width: 877px; height: 24px;background: RGB(224,237,248)">
            <tr>
                <td style="height: 24px; width: 25%;font-color:black;border-right:1px solid rgb(172,210,233);font-weight:bold">&nbsp; 天昱金元基本信息</td>
        ...
        <tr>
        <td class="style2"><asp:Image runat="server" ImageUrl="~/i/jbxx.png" /></td>
        </tr>
       ...
       <table style="width:820px;margin-top:30px; margin-left:25px;border-bottom:1px dotted rgb(212,212,212)">
        <tr>
        <td><asp:Image ID="Image1" runat="server" ImageUrl="~/i/cwxx.png" /></td>
        </tr>
        <tr style="height:30px">
