<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lubei_three.aspx.cs" Inherits="房产系统.lubei_three" %>
...
<body>
   ...
   <asp:Button runat="server" ID="btn1" width="60px" Height="40px" Text="搜索" style="color:red;font-size:20px" />
    <div id="top">
        ...
        <br />
  <div id="slW">&nbsp;区域&nbsp;&nbsp; <a href="">不限</a>&nbsp;&nbsp; <a href="">路北</a>&nbsp;&nbsp; <a href="">路南</a><br />
      <br />
      <br />
        </div><br />
        <br />
  ...
  <asp:ListItem Text="前六个月已开" ></asp:ListItem>
    ...
    <div id="p">
    <a href=""><asp:Image runat="server" ID="img4" Width="200" Height="140px" ImageUrl="~/FrontPages/i/anlian.jpg" /></a>
        <div id="lp">
            <br />
            <a href="">安联优悦城</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-weight:bold;font-size:20px;color:red">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 4900</span>元/m²</div>
        <div id="js">&nbsp;&nbsp;&nbsp; 二居（5）三居（7）
        </div>
        <div id="wz">&nbsp;&nbsp;&nbsp;&nbsp;长宁道与龙泽路交汇处东行300米路南<span style="font-weight:bold;color:red">&nbsp;
           &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 400</span>-<span style="font-weight:bold;color:red">890</span>-<span style="font-weight:bold;color:red">0000</span>转<span style="font-weight:bold;color:red">616699</span></div>
         <div>&nbsp;&nbsp;&nbsp;&nbsp;
             <br />
&nbsp;&nbsp;&nbsp; <span style="border:1px solid gray">4套可售</span>&nbsp;&nbsp; <span style="border:1px solid gray">小户型</span>&nbsp;&nbsp; <span style="border:1px solid gray">南北通透</span>&nbsp;&nbsp; <span style="background-color:red;color:White">划片</span><span style="border:1px solid gray">唐山市七十号小学</span>
        </div>
        </div>
        <div id="p1">
    <a href=""><asp:Image runat="server" ID="img" Width="200" Height="140px" ImageUrl="~/FrontPages/i/fuqiang.jpg" /></a>
        <div id="lp1">
            <br />
            <a href="">富强城</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-weight:bolder;font-size:20px;color:red">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 6300</span>元/m²</div>
        <div id="js1">&nbsp;&nbsp;&nbsp; 一居（7）二居（10）三居（2）
        </div>
        <div id="wz1">&nbsp;&nbsp;&nbsp; 北新道与华岩路交叉口西北侧<span style="font-weight:bold;color:red">&nbsp;
...
&nbsp;&nbsp;&nbsp; <span style="border:1px solid gray">93套可售</span>&nbsp;&nbsp; <span style="border:1px solid gray">小户型</span>&nbsp;&nbsp; <span style="border:1px solid gray">板楼</span>&nbsp;&nbsp; <span style="border:1px solid gray">塔楼</span>&nbsp;&nbsp; <span style="border:1px solid gray">商住楼</span>&nbsp;&nbsp; 
        ...
        <div id="p2">
    <a href=""><asp:Image runat="server" ID="img1" Width="200" Height="140px" ImageUrl="~/FrontPages/i/zijin.jpg" /></a>
        <div id="lp2">
            <br />
            <a href="">紫金锦苑</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-weight:bold;font-size:20px;color:red">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;6800</span>元/m²</div>
        <div id="js2">&nbsp;&nbsp;&nbsp; 二居（1）三居（5）四居（1）
        </div>
        <div id="wz2">&nbsp;&nbsp;&nbsp; 北新道北侧，原唐山车管所用地<span style="font-weight:bold;color:red">&nbsp;
...
&nbsp;&nbsp;&nbsp; <span style="border:1px solid gray">103套可售</span>&nbsp;&nbsp; <span style="border:1px solid gray">大户型</span>&nbsp;&nbsp; <span style="border:1px solid gray">双卫</span>&nbsp;&nbsp; <span style="background-color:Red;color:white">划片</span><span style="border:1px solid gray">唐山市路北区实验小学</span>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         <span style="border:1px solid gray;text-align:center;font-size:20px;color:Black"><asp:label ID="Label2" runat="server" Width="30px" Height="40px"><a href="start.aspx">1</a></asp:label></span>&nbsp; <span style="border:1px solid gray;text-align:center;font-size:20px;color:Black"><asp:label ID="Label3" runat="server" Width="30px" Height="40px"><a href="two.aspx">2</a></asp:label></span>&nbsp; <span style="background-color:red;color:white;text-align:center;font-size:20px"><asp:label ID="Label1" runat="server" Width="30px" Height="40px"><a href="three.aspx">3</a></asp:label></span>&nbsp; 
