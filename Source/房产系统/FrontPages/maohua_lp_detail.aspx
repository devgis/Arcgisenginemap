<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="maohua_lp_detail.aspx.cs" Inherits="房产系统.maohua_lp_detail" %>
...
<body>
    ...
    <div id="top">
        <span style="font-size: 10px"><a href="">唐山新房</a> > <a href="">路北楼盘</a> >
    ...
    <div id="dh" style="background: RGB(223,223,223)">
        <table style="width: 1197px; height: 30px">
            <tr>
                ...
                <td style="height: 24px; width: 33%">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                        href="maohua_lp_photo.aspx"><font color="black">楼盘相册</font></a>
                </td>
                <td style="height: 24px; width: 33%; background-color: red">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="maohua_lp_detail.aspx"><font color="black">楼盘详情</font></a>
                </td>
            </tr>
        </table>
    </div>
  ...
  <div id="center">
        <table style="width: 877px; height: 24px;background: RGB(224,237,248)">
            <tr>
                <td style="height: 24px; width: 25%;font-color:black;border-right:1px solid rgb(172,210,233);font-weight:bold">&nbsp; 茂华唐山中心基本信息</td>
        ...
        <tr>
        <td class="style2"><asp:Image runat="server" ImageUrl="~/FrontPages/i/jbxx.png" /></td>
        </tr>
        <tr style="height:30px">
        <td style="font-color:black;font-size:15px;font-weight:bold;padding-left:5px;" 
                class="style2">物业类别:</td>
        <td class="style4"><asp:Label runat="server" id="lbl1" style="font-size:14px;width:30%;"></asp:Label></td>
        <td style="font-color:black;font-size:15px;font-weight:bold;" class="style5">项目特色:</td>
        <td class="style7"><asp:Label ID="lbl2" runat="server"  style="font-size:14px;width:30%"></asp:Label></td>
        </tr>
        <tr style="height:30px">
        <td style="font-color:black;font-size:15px;font-weight:bold;padding-left:5px;" 
                class="style2">建筑类别:</td>
        <td class="style4"><asp:Label ID="lbl3" runat="server" style="font-size:14px;width:30%"></asp:Label></td>
        <td style="font-color:black;font-size:15px;font-weight:bold;" class="style5">装修状况:</td>
        <td class="style7"><asp:Label ID="lbl4" runat="server" style="font-size:14px;width:30%"></asp:Label></td>
        </tr>
        <tr style="height:30px">
        <td style="font-color:black;font-size:15px;font-weight:bold;padding-left:5px;" 
                class="style2">容积率:</td>
        <td class="style4"><asp:Label ID="lbl5" runat="server"  style="font-size:14px;width:30%"></asp:Label></td>
        <td style="font-color:black;font-size:15px;font-weight:bold;" class="style5">绿化率:</td>
        <td class="style7"><asp:Label ID="lbl6" runat="server"  style="font-size:14px;width:30%"></asp:Label></td>
        </tr>
        <tr style="height:30px">
        <td style="font-color:black;font-size:15px;font-weight:bold;padding-left:5px;" 
                class="style2">开盘时间:</td>
        <td class="style4"><asp:Label ID="lbl7" runat="server" style="font-size:14px;width:30%"></asp:Label></td>
        <td style="font-color:black;font-size:15px;font-weight:bold;" class="style5">交房时间:</td>
        <td class="style7"><asp:Label ID="lbl8" runat="server"  style="font-size:14px;width:30%"></asp:Label></td>
        </tr>
        <tr style="height:30px">
        <td style="font-color:black;font-size:15px;font-weight:bold;padding-left:5px;" 
                class="style2">物业费:</td>
        <td class="style4"><asp:Label ID="lbl9" runat="server"  style="font-size:14px;width:30%"></asp:Label></td>
        <td style="font-color:black;font-size:15px;font-weight:bold;" class="style5">物业公司:</td>
        <td class="style7"><asp:Label ID="lbl10" runat="server" style="font-size:14px;width:30%"></asp:Label></td>
        </tr>
        <tr style="height:30px">
        <td style="font-color:black;font-size:15px;font-weight:bold;padding-left:5px;" 
                class="style2">开发商:</td>
        <td class="style4"><asp:Label ID="lbl11" runat="server" style="font-size:14px;width:600px"></asp:Label></td>
        </tr>
        <tr style="height:30px">
        <td style="font-color:black;font-size:15px;font-weight:bold;padding-left:5px;" 
                class="style2">售楼地址:</td>
        <td class="style4"><asp:Label ID="lbl12" runat="server"  style="font-size:14px;width:600px"></asp:Label></td>
        </tr>
        <tr style="height:30px">
        <td style="font-color:black;font-size:15px;font-weight:bold;padding-left:5px;" 
                class="style2">物业地址:</td>
        <td class="style4"><asp:Label ID="lbl13" runat="server"  style="font-size:14px;width:600px"></asp:Label></td>
        </tr>
        <tr style="height:30px">
        <td style="font-color:black;font-size:15px;font-weight:bold;padding-left:5px;" 
                class="style2">交通状况:</td>
        <td class="style4"><asp:Label ID="lbl14" runat="server"  style="font-size:14px;width:600px"></asp:Label></td>
        </tr>
        </table>
        ...
        <td style="font-color:black;font-size:15px;font-weight:bold;padding-left:5px;width:19%" 
                class="style8">茂华唐山中心房价:</td>
        <td class="style4"><asp:Label ID="lbl15" runat="server"  style="font-size:18px;width:600px;color:red;font-weight:bold"></asp:Label></td>
        </tr>
         <tr style="height:30px"></tr>
          </table>
       <table style="width:820px;margin-top:30px; margin-left:25px;border-bottom:1px dotted rgb(212,212,212);font-size:14px">
        <tr>
        <td class="style2"><asp:Image ID="Image3" runat="server" ImageUrl="~/FrontPages/i/xmpt.png"/></td>
        </tr>
        <tr >
        <td>
        <asp:Repeater runat="server" ID="rp1" >
        <ItemTemplate>
        <div style=" width:820px;"><%#Eval("equipment") %></div> 
        </ItemTemplate>
        </asp:Repeater>
            </td>
        </tr>
       ...
       <table style="width:820px;margin-top:30px; margin-left:25px;border-bottom:1px dotted rgb(212,212,212)">
        <tr>
        <td class="style2"><asp:Image ID="Image2" runat="server" ImageUrl="~/FrontPages/i/jtzk.png" /></td>
        </tr>
        <tr style="height:30px">
        <td><asp:Label ID="lbl16" runat="server" style="font-size:14px;width:820px;margin-left:2px"></asp:Label></td>
        </tr>
         <tr style="height:30px"></tr>
        </table> 
       <table style="width:820px;margin-top:30px; margin-left:25px;border-bottom:1px dotted rgb(212,212,212);font-size:14px">
        <tr>
         <td class="style2"><asp:Image ID="Image4" runat="server" ImageUrl="~/FrontPages/i1/lczk.png" /></td>
        </tr>
        <tr>
        <td>
        <asp:Repeater runat="server" ID="Repeater1">
        <ItemTemplate>
        <div style=" width:820px"><%#Eval("floor_condition") %></div> 
        </ItemTemplate>
        </asp:Repeater></td>
        </tr>
         <tr style="height:30px"></tr>
       ...
       <table style="width:820px;margin-top:30px; margin-left:25px;border-bottom:1px dotted rgb(212,212,212)">
        <tr>
        <td><asp:Image ID="Image1" runat="server" ImageUrl="~/FrontPages/i/cwxx.png" /></td>
        </tr>
        <tr style="height:30px">
        <td><asp:Label ID="lbl17" runat="server" style="font-size:14px;width:820px;margin-left:2px"><br /><br /><br /></asp:Label></td>
        </tr>
         <tr style="height:30px"></tr>
          </table> 
       <table style="width:820px;margin-top:30px; margin-left:25px">
        <tr>
        <td class="style2"><asp:Image ID="Image5" runat="server" ImageUrl="~/FrontPages/i/xgxx.png" /></td>
        </tr>
        <tr style="height:30px">
        <td style="font-color:black;font-size:15px;font-weight:bold;padding-left:5px;" 
                class="style2">占地面积:</td>
        <td class="style9"><asp:Label ID="lbl18" runat="server"  style="font-size:14px;width:30%;"></asp:Label></td></tr>
        <tr style="height:30px">
        <td style="font-color:black;font-size:15px;font-weight:bold;padding-left:5px;" 
                class="style2">建筑面积:</td>
        <td class="style9"><asp:Label ID="lbl19" runat="server"  style="font-size:14px;width:30%;"></asp:Label></td></tr>
        <tr style="height:30px">
        <td style="font-color:black;font-size:15px;font-weight:bold;padding-left:5px;" 
  ...
  <tr><span style="margin-left:10px"><a href="">龙泽国际</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;高新区</span></tr><br />
