<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wanda.aspx.cs" Inherits="房产系统.wanda" %>
...
<body>
   ...
   <asp:Button runat="server" ID="btn1" width="60px" Height="40px" Text="搜索" 
    ...
    <div id="top"><span style="font-size:10px"><a href="start.aspx">唐山新房</a> > <a href="">路南楼盘</a> > <a href="wanda.aspx">唐山万达广场</a></span><br />
        <br />
    </div>
    ...
    <table style=" width:1197px;  height:30px">
       <tr>
         <td style=" height:24px; width:33%;background-color:red ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="wanda.aspx"><font color="black" >楼盘首页</font></a></td>
         <td style=" height:24px; width:33%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="wanda_lp_photo.aspx"><font color=black>楼盘相册</font></a></td>
         <td style=" height:24px; width:33% ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="wanda_lp_detail.aspx"><font color="black" >楼盘详情</font></a></td>
       </tr>
       </table></div>
       <div id="center">
    <asp:Image runat="server" ID="img1" Width="480px" Height="320px" ImageUrl="i5/wanda_x1.jpg" style="margin-top:" />
    ...
    <td><asp:Label runat="server" ID="huxing" Width="550px" Height="28px" ></asp:Label></td>
     ...
     <table id="Table2" runat="server" width="680px" height=""  
               style="margin-left:517px;">
    <tr style="width:680px;height:28px">
    <td class="style2">&nbsp;&nbsp; <a href="wanda_lp_detail.aspx"><font color="red" size="3px">更多详细信息>> </font></a>&nbsp;&nbsp; </td></tr>
    </table>
    </form>
</body>
</html>
