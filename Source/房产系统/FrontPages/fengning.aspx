<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fengning.aspx.cs" Inherits="房产系统.fengning" %>
...
<body>
   ...
   <asp:Button runat="server" ID="btn1" width="60px" Height="40px" Text="搜索" 
    ...
    <div id="top"><span style="font-size:10px"><a href="start.aspx">唐山新房</a> > <a href="lubei.aspx">路北楼盘</a> > <a href="fengning.aspx">丰宁锦苑</a></span><br />
        <br />
    </div>
    ...
    <table style=" width:1197px;  height:30px">
       <tr>
         <td style=" height:24px; width:33%;background-color:red ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="fengning.aspx"><font color="black" >楼盘首页</font></a></td>
         <td style=" height:24px; width:33%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="fengning_lp_photo.aspx"><font color=black>楼盘相册</font></a></td>
         <td style=" height:24px; width:33% ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="fengning_lp_detail.aspx"><font color="black" >楼盘详情</font></a></td>
       </tr>
       </table></div>
       <div id="center">
    ...
    <tr style="width:680px;height:28px">
    <td style="width:150px;font-weight:bold;padding-top:10px" class="style3">价格：</td>
    <td><asp:Label runat="server" ID="price" Width="550px" Height="28px"  ></asp:Label></td>
    </tr>
     <tr style="width:680px;height:28px">
    <td style="width:150px;font-weight:bold;padding-top:10px" class="style3">最新开盘：</td>
    <td><asp:Label runat="server" ID="kaipan" Width="550px" Height="28px" ></asp:Label></td>
    </tr>
     <tr style="width:680px;height:28px">
    <td style="width:150px;font-weight:bold;padding-top:10px" class="style3">楼盘地址：</td>
    <td><asp:Label runat="server" ID="position" Width="550px" Height="28px" ></asp:Label></td>
    </tr>
     <tr style="width:680px;height:28px">
    <td style="width:150px;font-weight:bold;padding-top:10px" class="style3">主力户型：</td>
    <td><asp:Label runat="server" ID="huxing" Width="550px" Height="28px" ></asp:Label></td>
     ...
     <table id="Table2" runat="server" width="680px" height=""  
               style="margin-left:517px;">
    <tr style="width:680px;height:28px">
    <td class="style2">&nbsp;&nbsp; <a href="fengning_lp_detail.aspx"><font color="red" size="3px">更多详细信息>> </font></a>&nbsp;&nbsp; </td></tr>
    </table>
    <div style="width:680px;height:28px;background-color:rgb(244,244,244);margin-left:100px"></div>
    </div>
    <br /><br /><br />
    </form>
</body>
