<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GSXX.aspx.cs" Inherits="房产信息管理.GSXX" %>
...
<body>
    <form id="form1" runat="server">
     <div  style="background-image:url('image/bj2.jpg'); background-repeat:no-repeat; height: 575px; background-position:center; width: 822px; margin-right: 0px; margin-top: 6px; text-align:center;" ><br /><br /><br /><br />
        &nbsp;
    <asp:Label style="font-weight:bold; text-align:center;"  ID="lb1" runat="server" Text="公司消息管理"  
   ...
   <%-- <table style="text-align:center" >
    ...
    <table style="text-align:center">
    <tr>
      <td>&nbsp;&nbsp; <a href='ZY_NR.aspx?zy_id=<%#Eval("ZY_ID") %>'>消息编号：</td><%#Eval("ZY_BT") %></a></td>
      <td>&nbsp;&nbsp;消息名称：<%#Eval("WZ_MC","{0:d}") %></td>
      
     <td> &nbsp;&nbsp;发表时间： <%#Eval("ZY_FBSJ", "{0:d}")%></td>
     <td>&nbsp;&nbsp;
