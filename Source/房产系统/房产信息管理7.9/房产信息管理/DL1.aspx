<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DL1.aspx.cs" Inherits="房产信息管理.DL" %>
...
<body>
    ...
    <div style="text-align:center;  background-image: url('/image/bj2.jpg');  font-weight:bold;  background-position:center;background-repeat: no-repeat; margin-top: 0px; height: 454px; width: 720px;"><br /><br />
    <asp:HyperLink runat="server" ID="HyperLink3" NavigateUrl="~/FM.aspx" 
           Text="<<返回主页" Font-Size="Large"></asp:HyperLink>
        <br />
        <br />
        <br /><br />
    <asp:Label ID="lb1" style="font-weight:bold" runat="server" Text="管理员登陆界面" 
