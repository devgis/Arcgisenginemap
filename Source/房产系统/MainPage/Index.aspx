<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="房产系统.MainPage.Index" %>
...
<meta http-equiv="Content-Type" content="text/html;charset=uf-8" />
    ...
    <script type="text/javascript" src="../js/LouPanChaXun.js"></script>
   <script runat="server">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 唐山市房产查询分析系统</div>
  <div id="menu"  style="margin-right:25px;margin-left:25px">
    <ul id="nav">
        <li ><a href="Route.aspx">到这去</a>
        <ul>
        <li></li>
        </ul>
        
        </li>
        <li><a href="Buffer.aspx">搜周边</a>
            <%--<ul>
                <li><asp:Button ID="lin" runat="server" BorderStyle="none" Text="线" Background="none" /></li>
                <li><a href="">楼盘查询</a></li> 
                <li><a href="">楼盘查询</a></li> 
  ...
  <div id="mainContent">
  <div id="index1"><input type="text" id="searchText"  />
    <input type="button" value="查询楼盘" onclick="execute(dojo.byId('searchText').value);" /></div>
    <div id="grid" dojoType="dojox.Grid" jsId="gridWidget" structure="layout" height:600px;></div>
  <div height="600px" id="divShowResult"></div>
   <%--<div id="sidebar"style="margin-left:25px">

  </div>--%>
  <div id="sidebar"style="margin-left:25px">
  <%--<div id="grid" dojoType="dojox.Grid" jsId="gridWidget" structure="layout" height:600px;>
  <div height="600px" id="divShowResult"></div>--%>
  </div>
<%--  <div id="main">--%>
    <div id="small" 
          style="margin-right:25px; width: 35px; background-color: #335399;">
            <div id="pan" class="navItem"
            style="height: 40px; background-color: #335399; margin-left: 3px;" >
         <img alt="" class="navItem" src="../picture/i_pan.png" title="平移"/>
       <%-- <input id="Button8" type="button" value="拖动" />--%>
         </div>
        <div  id="zoomin" class="navItem" 
            style="height: 40px; background-color: #335399;">
         <img alt=""  class="navItem" src="../picture/i_zoomin.png" title="放大"/>
         <%--<input id="Button1" type="button" value="放大" />--%>
                </div>
         <div  id="zoomout" style="height: 37px; background-color: #335399;" 
            class="navItem">
    ...
    <div id="map" class="map"
          style="margin: 10px; padding: 10px; background-color: #FFFFFF;" ></div>
          </div>
